...
def run_embedding(
    ...
    from cs336_basics.transformer_lm import Embedding
    embedding_layer = Embedding(vocab_size, d_model)
    weight_dict = {"embedding_matrix": weights}
    embedding_layer.load_state_dict(weight_dict)
...
def run_swiglu(
    ...
    from cs336_basics.transformer_lm import SwiGLU
...
def run_scaled_dot_product_attention(
    ...
    """
    from cs336_basics.transformer_lm import ScaledDotProductAttention
...
def run_rope(
    ...
    """
    from cs336_basics.transformer_lm import RotaryPositionalEmbedding
...
def run_rmsnorm(
    ...
    """
    from cs336_basics.transformer_lm import RMSNorm
    rms = RMSNorm(d_model, eps)
    dict = {"gain": weights}
    rms.load_state_dict(dict)
...
def run_softmax(in_features: Float[Tensor, " ..."], dim: int) -> Float[Tensor, " ..."]:
    ...
    softmax_later = softmax()
    return softmax_later(in_features, dim)
...
def run_cross_entropy(
    ...
    """
    from cs336_basics.train_transformer_lm import cross_entropy
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    from cs336_basics.train_transformer_lm import gradient_clipping
...
def get_adamw_cls() -> Any:
    ...
    """
    from cs336_basics.train_transformer_lm import AdamWOpt
    return AdamWOpt
...
def run_get_lr_cosine_schedule(
    ...
    """
    from cs336_basics.train_transformer_lm import learning_rate_schedule
...
def run_save_checkpoint(
    ...
    """
    from cs336_basics.train_loop import save_checkpoint
...
def run_load_checkpoint(
    ...
    """
    from cs336_basics.train_loop import load_checkpoint
